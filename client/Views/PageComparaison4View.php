...
class PageComparaison4View extends GlobalView
{
    public function content()
    {
        ...
        $vehicule_3 = $comparatorController->getVehicule($_GET['marque_3'], $_GET['modele_3'], $_GET['version_3'], $_GET['annee_3']);
        $vehicule_4 = $comparatorController->getVehicule($_GET['marque_4'], $_GET['modele_4'], $_GET['version_4'], $_GET['annee_4']);
        $comparatorController->compareFourVehicules($_GET['marque_1'], $_GET['modele_1'], $_GET['version_1'], $_GET['annee_1'], $_GET['marque_2'], $_GET['modele_2'], $_GET['version_2'], $_GET['annee_2'], $_GET['marque_3'], $_GET['modele_3'], $_GET['version_3'], $_GET['annee_3'], $_GET['marque_4'], $_GET['modele_4'], $_GET['version_4'], $_GET['annee_4']);
    ...
    <table class="table_compare w-full bg-white">
      <thead>
        <tr>
          ...
          <th>
            <form action="./redirect.php" method="post">
              <input type="hidden" value="<?php echo $vehicule_4['ID_Vehicule'] ?>" name="idVehicule">
              <input type="hidden" value="<?php echo $_GET['idClient'] ?>" name="idClient">
              <button type="submit" name="show-car-details">
                <img class="w-52 inline-block"
                  src="/cars-clash/public/images/vehicules<?php echo $vehicule_4['Image_vehicule'] ?>" alt="">
              </button>
            </form>
          </th>
        </tr>
      ...
      <tbody>
        <tr>
          ...
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_3['Modele'] ?></td>
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_4['Modele'] ?></td>
        </tr>
        <tr>
          ...
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_3['Version'] ?></td>
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_4['Version'] ?></td>
        </tr>
        <tr>
          ...
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_3['Annee'] ?></td>
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_4['Annee'] ?></td>
        </tr>
        <tr>
          ...
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_3['Dimensions'] ?></td>
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_4['Dimensions'] ?></td>
        </tr>
        <tr>
          ...
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_3['Consommation'] ?></td>
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_4['Consommation'] ?></td>
        </tr>
        <tr>
          ...
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_3['Moteur'] ?></td>
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_4['Moteur'] ?></td>
        </tr>
        ...
        <tr>
          ...
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_3['Performance'] ?></td>
          <td class="text-black font-semibold text-2xl"><?php echo $vehicule_4['Performance'] ?></td>
        </tr>
        ...
        <tr>
          ...
          <td class="text-myprimary font-bold text-3xl"><?php echo $vehicule_3['Prix'] ?>$</td>
          <td class="text-myprimary font-bold text-3xl"><?php echo $vehicule_4['Prix'] ?>$</td>
        </tr>
      </tbody>
    </table>
  </section>
