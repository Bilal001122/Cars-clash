...
<div
  ...
  <div class="flex flex-col">
    ...
    <select
      class="p-3 w-8/12 bg-myaccent bg-opacity-5 rounded-xl ring-2 ring-gray-300 focus:outline-none focus:ring-myprimary focus:ring-2"
      name="modele_<?php echo $numeroVoiture ?>" id="modele_<?php echo $numeroVoiture ?>"
      <?php if ($required) {echo "required";}?>>
    </select>
  ...
  <div class="flex flex-col">
    ...
    <select
      class="p-3 w-8/12 bg-myaccent bg-opacity-5 rounded-xl ring-2 ring-gray-300 focus:outline-none focus:ring-myprimary focus:ring-2"
      name="version_<?php echo $numeroVoiture ?>" id="version_<?php echo $numeroVoiture ?>"
      <?php if ($required) {echo "required";}?>>
    </select>
  ...
  <div class="flex flex-col">
    ...
    <select
      class="p-3 w-8/12 bg-myaccent bg-opacity-5 rounded-xl ring-2 ring-gray-300 focus:outline-none focus:ring-myprimary focus:ring-2"
      name="annee_<?php echo $numeroVoiture ?>" id="annee_<?php echo $numeroVoiture ?>"
      <?php if ($required) {echo "required";}?>>
    </select>
