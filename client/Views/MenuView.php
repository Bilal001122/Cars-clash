...
class MenuView
{
    ...
    {
        ?>
<div class="menu flex justify-around mt-12 bg-white rounded-xl drop-shadow-2xl overflow-hidden sticky top-10 z-50">
  ...
  <div class="marques <?php if ($number == 3) {
      ...
      <form action=" ./redirect.php" method="post">
    <input type="hidden" name="idClient" value="<?php echo $_GET['idClient'] ?>" />
    <button class="w-full h-full" name="goto-page-marques">
      Marques
    </button>
    </form>
  </div>
