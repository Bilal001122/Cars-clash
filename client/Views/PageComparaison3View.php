...
class PageComparaison3View extends GlobalView
{
    public function content()
    {
        ...
        $comparatorController->compareThreeVehicules($_GET['marque_1'], $_GET['modele_1'], $_GET['version_1'], $_GET['annee_1'], $_GET['marque_2'], $_GET['modele_2'], $_GET['version_2'], $_GET['annee_2'], $_GET['marque_3'], $_GET['modele_3'], $_GET['version_3'], $_GET['annee_3']);
